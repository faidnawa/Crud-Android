...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barisTabel.setBackgroundColor(Color.parseColor("#FF4081"));
        ...
        viewHeaderId.setPadding(2, 1, 2, 1);
        viewHeaderNama.setPadding(2, 1, 2, 1);
        viewHeaderAlamat.setPadding(2, 1, 2, 1);
        viewHeaderAction.setPadding(2, 1, 2, 1);
  ...
  /* restart acrtivity */
    ...
    public void getDataByID(int id) {
        ...
        builderEditBiodata.setIcon(R.drawable.b);
  ...
  /* layout akan ditampilkan pada AlertDialog */
        ...
        builderInsertBiodata.setIcon(R.drawable.b);
